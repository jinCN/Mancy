...
// sandbox
  ...
  if (process.platform !== 'win32' && context.process.env.PATH.indexOf() ==
    -1) {
...
function getAlphaNames () {
  ...
  return Object.getOwnPropertyNames(createContext())
    .concat(['goog', 'cljs'])
}
export default {
  createContext, getContext, builtIns, hookContext, getAlphaNames,
  missingBuiltIns
}
