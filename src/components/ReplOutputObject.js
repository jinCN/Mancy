...
export default class ReplOutputObject extends React.Component {
  ...
  render () {
    let label = ReplCommon.highlight(this.props.label ||
      this.getType(this.props.object))
            ...
            : <span className='repl-entry-message-output-object'>
              ...
              <span className='object-rec'>
              {
                _.map(this.getAllProps(), (key) => {
                  ...
                  let keyClass = Object.prototype.propertyIsEnumerable.call(this.props.object, key)
                    ? 'object-key'
                    : 'object-key dull'
                  return (
              ...
              }
                {
                  this.props.object.__proto__
                    ? <div className='object-entry' key='prototype'>
                      ...
                      <span className='object-colon'>: </span>
                      <ReplOutputObject
                        object={Object.getPrototypeOf(this.props.object)}
                        label={this.getType(this.props.object.__proto__)}
                        primitive={false}/>
                    </div>
                    : null
                }
