            ...
            : <span className='repl-entry-message-output-object'>
              ...
              <span className='object-rec'>
              {
                _.map(this.getAllProps(), (key) => {
                  ...
                  let keyClass = Object.prototype.propertyIsEnumerable.call(this.props.fun, key)
                    ? 'object-key'
                    : 'object-key dull'
                  return (
              ...
              }
                {
                  this.props.fun.__proto__
                    ? <div className='object-entry' key='prototype'>
                      ...
                      <span className='object-colon'>: </span>
                      <ReplOutputObject
                        object={Object.getPrototypeOf(this.props.fun)}
                        primitive={false}/>
                    </div>
                    : null
                }
                  ...
                  this.props.expandable
                    ...
                    ? <span className='repl-entry-message-output-function'>
                          <i className='fa fa-plus-square-o'
                             onClick={this.onToggleFunCollapse}></i>
                          <span
                            dangerouslySetInnerHTML={{ __html: this.props.short }}></span>
                        </span>
                    : <span className='repl-entry-message-output-function'>
