                ...
                }
                {
                  this.props.buffer.__proto__
                    ? <div className='object-entry' key='prototype'>
                      ...
                      <span className='object-colon'>: </span>
                      <ReplOutputObject
                        object={Object.getPrototypeOf(this.props.buffer)}
                        primitive={false}/>
                    </div>
                    : null
                }
                  ...
                  this.props.buffer.length
                    ...
                    ? <span className='repl-output-buffer-explorer-container'>
                        <i className='fa fa-plus-square-o'
                           onClick={this.onToggleExplorerCollapse}></i>
                        <span
                          className='data-explorer-label'>Data Explorer</span>
                      </span>
                    : <span className='repl-output-buffer-explorer-container'>
