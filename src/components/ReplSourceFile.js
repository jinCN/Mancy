        ...
        this.props.location
          ...
          <span className='repl-source-file' title={this.props.location}>
            ...
            <i className="fa fa-external-link"
               onClick={this.openExternalFile}></i>
              </span>
          :
          (
            isNativeModule
              ? <span className='repl-no-source-file'><span
                className='name'>'{this.props.name}'</span> is native module</span>
              : <span className='repl-no-source-file'>Unable to find source file for <span
                className='name'>'{this.props.name}'</span> module</span>
          )
      }
    </span>
    )
